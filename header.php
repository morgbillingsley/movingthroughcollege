...
<html lang="en">
   ...
   <!-- ALL VERSION CSS -->
   <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/css/versions.css">
   <!-- Responsive CSS -->
   <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/css/responsive.css">
   <!-- building CSS -->
   <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/css/building.css">
   </head>
   <body class="building_version" data-spy="scroll" data-target=".header">
      <!-- LOADER -->
      <div id="preloader">
         <img class="preloader" src="<?php bloginfo('template_url') ?>/images/loaders/loader-building2.gif" alt="">
      </div>
      <!-- end loader -->
      <!-- END LOADER -->
         ...
         <nav class="megamenu navbar navbar-default" data-spy="affix">
            ...
            <div class="container">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.html"><img src="<?php bloginfo('template_url'); ?>/images/logo-icon.png" alt="image"><span>Moving Through College</span></a>
               </div>
